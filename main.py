...
def complete_order():
    ...
    if selected_item:
        ...
        messagebox.showwarning("Нет выбора", "Выберите заказ для завершения.")
...
complete_button = tk.Button(app, text="Завершить заказ", font=("Arial", 16), command=complete_order)
